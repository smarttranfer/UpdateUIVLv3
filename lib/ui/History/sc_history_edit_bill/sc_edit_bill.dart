...
import 'package:vldebitor/ui/History/sc_history_edit_bill/card_edit_bill.dart';
import 'package:vldebitor/ui/home/home.dart';
import '../../../utilities/constants.dart';
import '../../shop/shop.dart';


class HistoryList_edit extends StatefulWidget {
  HistoryList_edit({Key? key}) : super(key: key);

  @override
  _HistoryList_edit createState() => _HistoryList_edit();
}

class _HistoryList_edit extends State<HistoryList_edit> {
                        ...
                        child: checknull
                            ...
                            child: SmartRefresher(
                                ...
                                child: ListView.builder(
                                    itemCount: constant_history_bill.listhistory_edit_bill.length,
                                    itemBuilder: (BuildContext context, int index) {
                                      return History_edit_bill(
                                        constant_history_bill.listhistory_edit_bill[index].ID_log,
                                        constant_history_bill.listhistory_edit_bill[index].status,
                                        constant_history_bill.listhistory_edit_bill[index].content,
                                        constant_history_bill.listhistory_edit_bill[index].user,
                                        constant_history_bill.listhistory_edit_bill[index].invoice,
                                        constant_history_bill.listhistory_edit_bill[index].create_date,
                                      );
                                    })))),
                  ))
            ],
